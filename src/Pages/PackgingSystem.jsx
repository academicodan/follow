...
export const PackgingSystem = () => {
  ...
  const handleNextStep = () => {
    ...
    var data = JSON.stringify({"channel":"pucchannel","chaincode":"oabcs-medicine-puc","chaincodeVer":"v2","method":"addItemEmbalado","args":[codigoLoteEmbalagens,datetimenow,tipoFarmacoEmbalagem,quantidadeFarmacoEmbalagem,pesoEmbalagem]});
